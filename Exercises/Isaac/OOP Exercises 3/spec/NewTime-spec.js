(function () {
    ...
    describe("Testing NewTime class", function () {
        ...
        it("should work with all its methods", function () {
            ...
            expect(time.nextSecond()).toBe(time);
            expect(time.toString()).toBe("00:00:00");
            for (let i = 0; i < 7200; i++) {
                time.nextSecond();
            }
            expect(time.toString()).toBe("02:00:00");
            expect(time.previousSecond()).toBe(time);
