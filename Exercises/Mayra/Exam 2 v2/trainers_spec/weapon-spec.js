    ...
    describe('Own methods', () => {
      describe('isItEnchanted method', () => {
        it('should return the value of the IsEnchanted property of the instance', () => {
          expect(weapon.itIsEnchanted()).toBe(false);
        });
      });
      describe('beEnchanted method', () => {
        it('should enchant the weapon and set the IsEnchanted property to true', () => {
          weapon.beEnchanted();
          expect(weapon.itIsEnchanted()).toBe(true);
        });
      });
      describe('itIsOneHanded method', () => {
        it('should return true if value of the IsOneHanded property of the instance is true', () => {
          expect(weapon.itIsOneHanded()).toBe(true);
        });
      });
      describe('itIsUpgraded method', () => {
        it('should return true if value of the IsUpgraded property of the instance is true', () => {
          expect(weapon.itIsUpgraded()).toBe(false);
        });
      });
      describe('beUpgradedWeapon method', () => {
        it('should upgreade the weapon and set the IsUpgraded property to true', () => {
          weapon.beUpgradedWeapon();
          expect(weapon.itIsUpgraded()).toBe(true);
        });
      });
