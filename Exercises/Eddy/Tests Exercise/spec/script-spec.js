/**
 * script-spec.js  demo  how to use jasmine with Lorenzo's probes
 * Created by EDDY on 06/09/2016.
 */

function validate (numOne, numTwo) {
	if (isNaN (numOne) || isNaN (numOne) || numOne === null || numTwo === null || numOne === undefined || numTwo === undefined || numTwo instanceof Array === true || numOne instanceof Array === true || numTwo === true || numOne === true || numTwo === false || numOne === false || numTwo instanceof Object === true || numOne instanceof Object === true) {
		return NaN;
	}
	return false;
}
...
describe ("Testing basic functions", function () {
	...
	describe ("Testing suma function", function () {
		...
		describe ("Tests against values that are not numbers", function () {
			...
			it ("should not work with functions", function () {
				expect (isNaN (suma (function () {
				}, function () {
				}))).toBe (true);
				expect (isNaN (suma (function () {
				}, 1))).toBe (true);
				expect (isNaN (suma (0, function () {
				}))).toBe (true);
				expect (suma (function () {
					}, function () {
					}) + "").toBe ("NaN");
			});
		});
	...
	describe ("Testing resta function", function () {
		...
		describe ("Tests against values that are not numbers", function () {
			...
			it ("should not work with functions", function () {
				expect (isNaN (resta (function () {
				}, function () {
				}))).toBe (true);
				expect (isNaN (resta (function () {
				}, 1))).toBe (true);
				expect (isNaN (resta (0, function () {
				}))).toBe (true);
				expect (resta (function () {
					}, function () {
					}) + "").toBe ("NaN");
			});
		});
	...
	describe ("Testing multiplicacion function", function () {
		...
		describe ("Tests against values that are not numbers", function () {
			...
			it ("should not work with functions", function () {
				expect (isNaN (multiplicacion (function () {
				}, function () {
				}))).toBe (true);
				expect (isNaN (multiplicacion (function () {
				}, 1))).toBe (true);
				expect (isNaN (multiplicacion (0, function () {
				}))).toBe (true);
				expect (multiplicacion (function () {
					}, function () {
					}) + "").toBe ("NaN");
			});
		});
	...
	describe ("Testing division function", function () {
		...
		describe ("Tests against values that are not numbers", function () {
			...
			it ("should not work with functions", function () {
				expect (isNaN (division (function () {
				}, function () {
				}))).toBe (true);
				expect (isNaN (division (function () {
				}, 1))).toBe (true);
				expect (isNaN (division (0, function () {
				}))).toBe (true);
				expect (division (function () {
					}, function () {
					}) + "").toBe ("NaN");
			});
		});
