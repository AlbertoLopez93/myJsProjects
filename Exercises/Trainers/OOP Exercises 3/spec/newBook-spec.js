...
describe("NewBook class", () => {
  ...
  describe("Methods", () => {
    ...
    describe("getAuthorsName method", () => {
      it("should be defined", () => {
        expect(newBook1.getAuthorsName).toBeDefined();
        expect(typeof newBook1.getAuthorsName).toBe("function");
      });
      it("should a string with a list of authors name following the pattern authorsName1, authorsName2, ...", () => {
        expect(newBook1.getAuthorsName()).toBe("John, Jennifer");
        expect(newBook2.getAuthorsName()).toBe("Jennifer");
      });
    });
  });
});
